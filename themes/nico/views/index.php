                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-6">
                        <div class="text-container">
                            ...
                            <a class="btn btn-primary btn-getstarted" href="<?=cn('auth/signup')?>" data-aos="fade-up" data-aos-delay="600"><?=lang("get_start_now")?> <i class="fas fa-arrow-right"></i> </a>
                        </div>
                    </div> 
                    <div class="col-lg-6 col-xl-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="text-container" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <a class="btn btn-primary btn-getstarted" href="<?=cn('auth/signup')?>">View Services <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
          ...
          <div class="row footer-top">
            <div class="col-lg-6 col-md-12 footer-info">
              ...
              <div class="icon-container">
                ...
                <?php if (get_option('social_tiktok_link')): ?>
                    <span class="fa-stack">
                        <a href="<?php echo get_option('social_tiktok_link'); ?>">
                            <i class="fas fa-circle fa-stack-2x"></i>
