        ...
        <div class="card">
          <div class="card-header d-flex align-items-center">
            <div class="tabs-list">
              <ul class="nav nav-tabs">
                ...
                <?php }} ?>
                <li class="m-t-10">
                  <a class="<?php echo (!$has_active) ? 'active show' : ''?>" data-toggle="tab" href="#qr_payment"><i class="fa fa-qrcode"></i> QR Payment</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="card-body">
            <div class="tab-content">
              ...
              <?php } ?>
              <div id="qr_payment" class="tab-pane fade <?php echo (!$has_active) ? 'in active show' : ''?>">
                <div class="add-funds-form-content">
                  <form class="form" action="<?php echo base_url('add_funds/qr_payment/index'); ?>" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="for-group text-center">
                          <img src="<?php echo BASE; ?>/assets/images/qr_code.png" alt="QR Code" style="max-width: 200px;">
                          <p class="p-t-10"><small><?php echo lang("scan_the_qr_code_to_make_payment_then_upload_screenshot"); ?></small></p>
                        </div>
                        <div class="form-group">
                          <label><?php echo sprintf(lang("amount_usd"), 'USD'); ?></label>
                          <input class="form-control square" type="number" name="amount" placeholder="10" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label class="custom-control custom-checkbox">
                            ...
                            <span class="custom-control-label text-uppercase"><strong><?php echo lang("yes_i_have_made_the_payment_and_uploaded_screenshot"); ?></strong></span>
                          </label>
                        </div>
                        <div class="form-actions left">
                          <input type="hidden" name="payment_id" value="0">
                          <button type="submit" class="btn btn-primary btn-min-width mr-1 mb-1"><?php echo lang("Submit"); ?></button>
                        </div>
                      </div>
                    </div>
                  </form>
